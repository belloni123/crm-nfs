...
export default function GlobalError({
  ...
  return (
    <html lang="pt-BR">
      <head>
        <title>Erro inesperado — No Front Scale</title>
      </head>
      <body style={{ margin: 0, background: '#0a0a0a', color: '#f5f5f5', fontFamily: 'Inter, system-ui, sans-serif' }}>
        <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 24, boxSizing: 'border-box' }}>
          <section style={{ width: '100%', maxWidth: 620, border: '1px solid rgba(255,255,255,.1)', borderRadius: 24, background: '#151515', padding: 40, boxSizing: 'border-box', boxShadow: '0 30px 90px rgba(0,0,0,.45)' }}>
            <div style={{ color: '#9fe870', fontSize: 12, fontWeight: 800, letterSpacing: '.18em', textTransform: 'uppercase' }}>No Front Scale · Erro crítico</div>
            ...
            <button type="button" onClick={retry} style={{ marginTop: 28, minHeight: 44, border: 0, borderRadius: 12, padding: '0 22px', background: '#9fe870', color: '#091302', fontWeight: 800, cursor: 'pointer' }}>
              Tentar novamente
            </button>
